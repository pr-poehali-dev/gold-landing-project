...
const Index = () => {
  return (
    <div className="bg-black text-white">
      ...
      <header className="bg-[#1A1A1A] py-4 px-6 shadow-md sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6 font-roboto">
            <a href="#services" className="hover:text-[#D4AF37] transition-colors duration-300">Услуги</a>
            <a href="#advantages" className="hover:text-[#D4AF37] transition-colors duration-300">Преимущества</a>
            <a href="#items" className="hover:text-[#D4AF37] transition-colors duration-300">Изделия</a>
            <a href="#contact" className="hover:text-[#D4AF37] transition-colors duration-300">Контакты</a>
          </div>
      ...
      <section className="min-h-[90vh] relative flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div 
            ...
            style={{ 
              backgroundImage: 'url("https://images.unsplash.com/photo-1610375461369-d613b564f4c4?q=80&w=2070")',
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-[#9B0000] hover:bg-red-800 text-lg">
                Оценить стоимость
              </Button>
              <Button size="lg" variant="outline" className="border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-black text-lg">
                Узнать цены
              </Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Ювелирные изделия</h3>
                <p className="text-gray-300 font-roboto">
                  Кольца, серьги, цепочки, браслеты, подвески из золота любой пробы. Принимаем изделия даже с повреждениями.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Монеты и слитки</h3>
                <p className="text-gray-300 font-roboto">
                  Золотые инвестиционные, коллекционные и памятные монеты. Оценка по каталогу с учетом нумизматической ценности.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Старинные монеты</h3>
                <p className="text-gray-300 font-roboto">
                  Золотые монеты царской России, СССР и зарубежные. Компетентная оценка редких экземпляров с учетом исторической ценности.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Часы и технические изделия</h3>
                <p className="text-gray-300 font-roboto">
                  Золотые корпуса часов, технический золотой лом, детали электроники, содержащие золото.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Зубные коронки</h3>
                <p className="text-gray-300 font-roboto">
                  Золотые зубные протезы и коронки, вышедшие из употребления. Оценка с учетом состава и веса.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-[#D4AF37] hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-montserrat font-bold mb-2">Антикварные изделия</h3>
                <p className="text-gray-300 font-roboto">
                  Старинные золотые изделия, предметы роскоши, украшения с исторической ценностью.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      {/* Преимущества */}
      <section id="advantages" className="py-20 bg-gradient-to-b from-black to-[#1A1A1A]">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Высокая оценка</h3>
                <p className="text-gray-300 font-roboto">
                  Используем профессиональное оборудование для точного определения пробы и веса. Предлагаем лучшие цены на рынке.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Моментальная выплата</h3>
                <p className="text-gray-300 font-roboto">
                  Расчет происходит сразу после оценки. Выплачиваем деньги наличными или на карту в зависимости от ваших предпочтений.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Легальность и безопасность</h3>
                <p className="text-gray-300 font-roboto">
                  Работаем официально, заключаем договор купли-продажи. Все транзакции защищены и конфиденциальны.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Удобный график</h3>
                <p className="text-gray-300 font-roboto">
                  Работаем ежедневно с 9:00 до 21:00, включая выходные и праздники. Возможен выезд специалиста к вам.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Филиалы по всему городу</h3>
                <p className="text-gray-300 font-roboto">
                  Удобные пункты приема в разных районах города. Выбирайте ближайший к вам офис.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-montserrat font-bold mb-2">Программа лояльности</h3>
                <p className="text-gray-300 font-roboto">
                  Повышенные ставки для постоянных клиентов. Специальные предложения для крупных партий.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="relative group overflow-hidden rounded-lg">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                <p className="text-white p-4 font-montserrat">Золотые цепочки</p>
              </div>
            </div>
            <div className="relative group overflow-hidden rounded-lg">
              <img 
            ...
            <div className="relative group overflow-hidden rounded-lg">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                <p className="text-white p-4 font-montserrat">Старинные монеты</p>
              </div>
            </div>
            <div className="relative group overflow-hidden rounded-lg">
              <img 
            ...
            <div className="relative group overflow-hidden rounded-lg">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                <p className="text-white p-4 font-montserrat">Коллекционные монеты</p>
              </div>
            </div>
            <div className="relative group overflow-hidden rounded-lg">
              <img 
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                <p className="text-white p-4 font-montserrat">Ювелирные украшения</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-6">
                Узнайте <span className="text-[#9B0000]">предварительную стоимость</span>
              </h2>
              <p className="text-gray-300 mb-8 font-roboto">
                Заполните форму, и наш специалист свяжется с вами для уточнения деталей и предварительной оценки.
                Окончательная оценка производится при личной встрече.
              </p>
              <form className="space-y-4">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Нажимая кнопку "Отправить на оценку", вы соглашаетесь с политикой обработки персональных данных
                </p>
              </form>
            </div>
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-montserrat font-bold mb-2">Адреса</h3>
                    <p className="text-gray-300 font-roboto">
                      г. Москва, ул. Тверская, 15<br />
                      г. Москва, Кутузовский проспект, 30<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-montserrat font-bold mb-2">Время работы</h3>
                    <p className="text-gray-300 font-roboto">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-montserrat font-bold mb-2">Телефоны</h3>
                    <p className="text-gray-300 font-roboto">
                      +7 (495) 123-45-67<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-roboto">
                      info@zolotoskupka.ru<br />
                      support@zolotoskupka.ru
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-6 md:mb-0 text-sm font-roboto">
              ...
              <a href="#items" className="hover:text-[#D4AF37] transition-colors duration-300">Изделия</a>
              <a href="#contact" className="hover:text-[#D4AF37] transition-colors duration-300">Контакты</a>
              <a href="#" className="hover:text-[#D4AF37] transition-colors duration-300">Политика конфиденциальности</a>
            </div>
            <div className="flex gap-4">
              <a href="#" className="bg-[#1A1A1A] p-2 rounded-full hover:bg-[#9B0000] transition-colors duration-300">
